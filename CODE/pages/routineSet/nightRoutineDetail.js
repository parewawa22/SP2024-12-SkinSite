...
export default function RoutineDetail() {
  ...
  const handleAddStep = (stepOrder) => {
    router.push(`/routineSet/nightStep?order=${stepOrder}&routine_id=${routine_id}`);
  };

  const handleEditStep = (stepid, stepOrder) => {
    router.push(`/routineSet/nightStep?edit=true&stepid=${stepid}&routine_id=${routine_id}&order=${stepOrder}`);
  };
